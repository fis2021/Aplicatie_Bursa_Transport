...
class MyOffersPageControllerTest {
    ...
    public void handleGoodsList(Stage window) throws Exception {
        ...
        UserService.addUser(APA,APA,"Trucking operator","victor~apa~250 euro~2021-05-20~No information!~Closed|15 tone-Chisinau-Timisoara-TransSRL-str. Albita 11");
        try {
    ...
    @Test
    void testHandleReturn(FxRobot robot){

        robot.clickOn("#returnButtonMyOffersPage");
